...
export function setup(ctx: Ctx, opts?: any) {
  ...
  function showFloatMenu() {
    ...
    const entry = (label: string, run: () => void) => {
      ...
      b.addEventListener("pointerenter", (e: any) => {
  ...
  if (typeof document !== "undefined") {
    ...
    disposers.push(() => {
      try { document.removeEventListener("pointerdown", onPointerKind, true); } catch (_) {}
      try { document.removeEventListener("pointermove", onPointerKind, true); } catch (_) {}
  ...
  function buildChatSwitchRow(): HTMLElement {
    ...
    if (lastChatId == null) askActiveChat();
  ...
  function buildRow(f: Field): HTMLElement {
    ...
    if (f.hint) {
      ...
      info.addEventListener("pointerenter", (e: any) => {
        if (fromMouse(e)) open();
      });
      ...
      info.addEventListener("pointerleave", (e: any) => {
