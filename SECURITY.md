...
- **Do not paste chat text you would not want read.** A debug report can carry short fragments of a reply, and the Copy button on the panel's Prompt tab copies most of a chat. Delete those parts before you send it.
