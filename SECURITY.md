...
Open an issue at [github.com/starlitcode/Lumiverse-Auto-Retry/issues](https://github.com/starlitcode/Lumiverse-Auto-Retry/issues). If it is something you would rather not describe in public, open an issue saying so without the details and I will find another way to talk about it.
