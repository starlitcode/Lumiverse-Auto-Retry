...
- **Saved presets are counted, deleted and synced as one set.** Three places reached past the store into the word swap presets alone. Refusal note presets did not follow your account to another device, the count offered before deleting left them out, and deleting what the panel called word swap presets took them with it anyway. All three now cover both kinds. The reset picker says **Delete saved presets**, and the tick box under Import / export says **Word swap and refusal note presets**, since it always moved every kind whatever it was called.
- **The Import / export and Reset tick boxes are named after everything in them.** Two of them quietly carried more than their name said: **Retry behavior** also held whether the floating and Extras on/off buttons are shown, and **Refusal detection** also held the note wording sent on a retry. Ticking one to move a setting and carrying another without knowing is the same mistake as leaving one unticked because its name did not sound like it covered what you wanted. The parts are now **Retry behavior and the on/off buttons**, **Refusal detection and notes**, **Word swaps**, **Button selectors**, **The pop-up and the on-screen panel**, and **Word swap and refusal note presets**.
