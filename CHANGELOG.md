...
- **The Debug info tick boxes are named after everything in them.** **Browser and screen** also carried your permissions, and a missing permission is the one thing that explains a report where nothing happened at all. **Button match status** also carried the selectors you wrote. They are now **Permissions, browser and screen** and **Buttons and selectors**.
- **The Import / export and Reset tick boxes are named after everything in them.** Two carried more than their name said: **Retry behavior** also held whether the on/off buttons are shown, and **Refusal detection** also held the note wording sent on a retry. The parts are now **Retrying and its buttons**, **Refusals and notes**, **Word swaps**, **Button selectors**, **Panel and pop-up**, and **All presets**.
